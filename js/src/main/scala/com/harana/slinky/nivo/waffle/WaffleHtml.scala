...
@JSImport("react-nivo", "WaffleHtml")
object ReactWaffleHtml extends js.Object

@react object WaffleHtml extends ExternalComponent {
  ...
  override val component = ReactWaffleHtml
}