...
@JSImport("react-nivo", "TreeMapHtml")
object ReactTreeMapHtml extends js.Object

@react object TreeMapHtml extends ExternalComponent {
  ...
  override val component = ReactTreeMapHtml
}