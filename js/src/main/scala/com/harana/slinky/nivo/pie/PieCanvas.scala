...
@JSImport("react-nivo", "PieCanvas")
@js.native
object ReactPieCanvas extends js.Object

@react object PieCanvas extends ExternalComponent {
  ...
  override val component = ReactPieCanvas
}