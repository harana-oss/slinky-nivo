...
@JSImport("react-nivo", "ChoroplethCanvas")
@js.native
object ReactChoroplethCanvas extends js.Object

@react object ChoroplethCanvas extends ExternalComponent {
  ...
  override val component = ReactChoroplethCanvas
}